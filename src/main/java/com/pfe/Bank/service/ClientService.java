    ...
    public class ClientService {
        ...
        public List<Client> getAllClientsWithNotations() {
            List<Client> clients = clientRepository.findClientsWithNotations();
        ...
        public List<Notation> getNotationsByClientId(Long clientId) {
            return notationRepository.findByClientId(clientId);
        }
        public List<Client> getClientsWithNotations() {
            return clientRepository.findClientsWithNotations();
        }
        public List<Object[]> getTotalNotationsForEachClient() {
            return clientRepository.getTotalNotationsForEachClient();
        }
    }